 ...
 * @author Robert Fisch
 */
public class Search extends LangDialog implements ActionListener, KeyListener
{
	...
	private void initComponents() {
		...
		//======== dialogPane ========
		{
			...
			dialogPane.setPreferredSize(new Dimension(220, 106));
			...
			//======== contentPanel ========
			{
				...
				//======== pnlRight ========
				{
					...
					//======== pnlFor ========
					{
						pnlFor.setBorder(new TitledBorder("Search"));
			...
			//======== buttonBar ========
			{
				...
				btnOK.addActionListener(new ActionListener() { public void actionPerformed(ActionEvent event) { diagram.setHightlightVars(btnOK.isSelected()); doButtons(); } } );
